...
local unitCollisionVolume = {}
	...
	unitCollisionVolume["armamb"] = {
		on={52,49,52,-0.5,-14,0,0,1,0},
		off={52,29,52,-0.5,-14,0,0,1,0},
	}
	...
	unitCollisionVolume["corgant"] = {
		on={98,96,100,0,-21,0,1,1,2},
		off={90,66,100,0,-21,0,1,1,2},
	}
	...
	unitCollisionVolume["corsolar"] = {
		on={56,58,56,0,-25,0,0,1,0},
		off={47,58,47,0,-35,0,0,1,0},
	}
	...
	unitCollisionVolume["cortoast"] = {
		on={47,25,47,0,4,0,2,1,0},
		off={47,25,47,0,-3.3,0,2,1,0},
	}
